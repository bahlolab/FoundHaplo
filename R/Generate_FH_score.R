...
Generate_FH_score=function(DCV,minor_allele_cutoff=0,gen_allele_mismatch_rate=0.01,MA_cutoff=-0.4,meiosis=1,imputation_quality_score_cutoff_test=0,frequency_type,geneticMap_DIR,disease_files_DIR,test_file,test_name="test",test_list,data_type,controls_file_DIR,save_report_DIR,TEMP_DIR)
{
  ...
  for(j in 1:length(list_of_disease_individuals)) # loop over all disease haplotypes in disease_files_DIR
  {
