...
pathogenic_mutations <- data.frame(mutation_id=mutation_id,
                                   ...
                                   chr=paste0("\"",chr,"\""), start_hg19=start_hg19, end_hg19=end_hg19,start_hg38=start_hg38,end_hg38=end_hg38,
                                   start_cm=start_cm, end_cm=end_cm,
                                   stringsAsFactors=FALSE)
...
genotypes <- data.frame(marker_id=1:nrow(disease_hap_file), sample_id=sample_id, genotype=disease_hap_file$h1,imputed=1,imputation_quality=R2,format_vcf=paste0("\"",x1,"\""),
                        stringsAsFactors=FALSE)
