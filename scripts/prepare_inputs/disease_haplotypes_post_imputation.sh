...
Rscript $FoundHaplo_DIR/scripts/prepare_inputs/Run_Phasing_by_pedigree.R $FoundHaplo_DIR/temp/ready.to.phase.vcf $FoundHaplo_DIR/input_files/input_vcf_data/disease_haplotypes $SAMPLE_INFO_FILE 1
