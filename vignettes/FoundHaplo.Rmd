...
# temp_DIR/1 will have disease haplotypes in VCF format. disease haplotype column in each file is named "h1", with homozygous genotypes in every VCF file.
```
...
#Calculate_IBD generates the IBD report and saves it in a given directory as a text file
