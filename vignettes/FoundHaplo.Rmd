...
# Assuming disease haplotypes are sourced from a directory instead of FoundHaplo database
...
temp_DIR <- tempdir()
setwd( temp_DIR )
# FH_IBD_scores represents all the concatenated FH scores from multiple .txt files
